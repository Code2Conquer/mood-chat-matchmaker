...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent-blue/10 via-white to-accent-pink/10">
      <Navbar />
      
      <main className="container mx-auto px-4 py-6">
        <div className="mb-8 py-8 text-center">
          <h1 className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary-purple to-primary-dark">
            Chat with AI Characters & Scenes
          </h1>
